...
class TextProcessingTest extends AnyFlatSpec {
  ...
  "test" should "identity names with votes in" in {
    val text =
      """ νομος αρκαδιας ρέππας δημήτριος - σπυρόπουλος ροβέρτος - τατούλης πέτρος +
        | κωστόπουλος δημήτριος - νομος αρτης κολιοπάνος θεόδωρος + κοσσυβάκης δημήτριος + καραμπίνας
        | κων/νος + περιφερεια νομου αττικης πάγκαλος θεόδωρος - βρεττός κων/νος + γιαννάκης ιωάννης +
        | παπαηλίας ηλίας + βλάχος γεώργιος + κατσίκης θεόδωρος - κατσιγιάννης αθανάσιος + μπούρας αθανάσιος +
        | αμπατζόγλου γεώργιος + νομος αχαϊας φούρας ανδρέας + χρυσανθακόπουλος αλέξανδρος + θωμά μαρία + θωμάς γεώργιος
        | + σπηλιόπουλος κων/νος + σπηλιωτόπουλος σπήλιος + νικολόπουλος νικόλαος + βασιλείου θεόφιλος +
        | κοσιώνης παναγιώτης - νομος βοιωτιας αποστολίδης λουκάς + ακριβάκης αλέξανδρος + μπασιάκος ευάγγελος +
        | τσιπλάκος αριστείδης + νομος γρεβενων τζιόλας ελευθέριος + νομος δραμας κωνσταντίνου φλώρος + παπαδόπουλος
        | σταύρος + δαϊλάκης σταύρος + νομος δωδεκανησου κρεμαστινός δημήτριος + σφυρίου κοσμάς + παπανικόλας
        | βασίλειος + παυλίδης αριστοτέλης +""".stripMargin.replaceAll("\n", " ")

    val nameWithVoteRegex = "[Α-ΩΆΈΌΊΏΉΎΫΪ́α-ωάέόίώήύϊΐϋΰ]+\\s*[+-]".r

    // print number of matches found
    println(nameWithVoteRegex.findAllIn(text).length)
  }
