...
object StopWords {
  def loadStopWords: Array[String] = {
  ...
  def loadDomainSpecificStopWords: Array[String] = {
    """ | αντιπρόεδρος αντιπρόεδρο αντιπρόεδρε αντιπροέδρου αντιπρόεδροι αντιπροέδρων αντιπροέδρους
        | άρθρο
        | βουλευτής βουλευτή βουλευτές βουλευτών
        | δεκτό
        | ευχαριστώ ευχαριστούμε
        | κύριε κύριος κύριο κύριοι κύριους κυρία κυρίες
        | λόγος λόγο
        | ορίστε
        | πρόεδρος πρόεδρο πρόεδρε προέδρου πρόεδροι προέδρων προέδρους
        | παρακαλώ
        | παρών
        | πλειοψηφία
        | συνάδελφος συνάδελφε συνάδελφου συνάδελφοι
        | υπουργός υπουργό υπουργού υπουργέ υπουργοί υπουργούς υπουργών υπουργείο υπουργεία
        | υφυπουργός υφυπουργό υφυπουργού υφυπουργέ υφυπουργοί υφυπουργούς υφυπουργών
        |""".stripMargin.split("\\s+")
  }
}
